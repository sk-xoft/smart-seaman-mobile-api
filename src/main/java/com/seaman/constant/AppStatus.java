...
public class AppStatus {
    ...
    public static final String SUCCESS_CODE = "MA00000";
    ...
    public static final String JWT_SIGNATURE_INVALID = "MA00007";
    public static final String JWT_EXPIRE = "MA00008";
    public static final String INVALID_UUID  = "MA00009";
    public static final String AUTH_TYPE_HEADER = "MA00011";
    public static final String EXCEPTION_DATABASE = "MA00012";
    public static final String EXCEPTION_TECHNICAL = "MA00013";
    public static final String USERNAME_IS_NOT_FOUND_SECURITY_CONTEXT = "MA00015";
